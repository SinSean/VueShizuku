...
<template>
    <div v-if="isLoading" class="pt-32 text-center text-gray-400">載入中...</div>
        ...
        <div class="max-w-[1300px] mx-auto px-6">
            ...
            [scrollbar-width:none]">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex flex-wrap gap-2.5">
                                <button v-for="size in availableSizes" :key="size"
                                        ...
                                        :class="['w-12 h-7 border text-xs font-medium tracking-wider transition-colors',
                                                 selectedSize === size
                                                    ? 'border-black bg-black text-white'
                                                    : 'border-gray-200 text-gray-700 hover:border-gray-400']">
                                    {{ size }}
                    ...
                    <div class="pt-6 border-t border-gray-100 space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex items-center border border-gray-200 h-10">
                                <button @click="quantity > 1 ? quantity-- : null"
                                        class="w-10 h-full text-gray-400 hover:text-black">-</button>
                        ...
                        <button class="w-full bg-black text-white h-11 text-sm font-bold tracking-[0.3em] uppercase hover:bg-gray-800 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                    ...
                    <div class="pt-6 border-t border-gray-100">
                        ...
                        <div class="border-b border-gray-100">
                            ...
                            <div v-show="openSection === 'model'"
                                 class="pb-4 text-xs text-gray-500 space-y-1">
                                <p>身高：162 cm</p>
                                <p>體重：45 kg</p>
                                <p>胸圍：78 cm</p>
                                <p>腰圍：60 cm</p>
                        ...
                        <div class="border-b border-gray-100">
                            ...
                            <div v-show="openSection === 'description'"
            ...
            <div class="mt-32 border-t border-gray-100 pt-16 pb-32">
                <div class="text-center mb-12">
                    <h2 class="text-gray-500 tracking-[0.2em] text-sm font-light">
                        \ 我想妳應該會喜歡 /
                    </h2>
                </div>
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-1 gap-y-10">
                    <RouterLink v-for="item in relatedProducts" :key="item.fId"
                                :to="'/product/' + item.fId"
                                class="group cursor-pointer block">
                        <div class="aspect-[3/4] overflow-hidden bg-gray-50 mb-3">
                            <img :src="item.fImage || 'https://placehold.co/300x400/f5f5f5/999?text=商品'"
                                 :alt="item.fName"
