...
<template>
  ...
  <Menu ref="menu" id="overlay_menu" :model="items" :popup="true" class="w-80 p-2">
    <template #item="{ item }">
      <div class="flex items-center gap-3 p-2 hover:bg-gray-50 rounded-md transition-colors group">
