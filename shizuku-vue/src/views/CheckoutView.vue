...
const submitOrder = async () => {
  ...
  try {
    ...
    const latestInfos = checkRes.data.data // 取得後端回傳的最新資訊
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="bg-gray-50/50 border-b border-gray-200 p-6 sm:p-10">
          ...
          <div class="flex gap-3 mb-6 pt-6 border-t border-gray-200">
            ...
            <button
              class="bg-gray-200 text-gray-500 font-bold px-6 rounded-md hover:bg-gray-300 hover:text-gray-700 transition"
            >
              套用
            </button>
          </div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div
                  ...
                  :class="[
                    ...
                    form.paymentMethodId === option.id
                  ...
                  <div class="flex flex-col items-center text-center gap-2">
                    <i
                      :class="[
                        ...
                        option.icon,
                        'text-2xl',
                        form.paymentMethodId === option.id ? 'text-black' : 'text-gray-400',
                      ]"
                    ></i>
                    <div>
                      <p
                        :class="[
                          'font-bold text-sm',
                          form.paymentMethodId === option.id ? 'text-black' : 'text-gray-600',
                        ]"
                      >
                        {{ option.name }}
                      </p>
