...
<template>
  <!--內部區塊再給間距 -->
  <div class="min-h-screen relative overflow-hidden flex flex-col bg-gradient-to-br from-blue-100 via-indigo-50 to-pink-100">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <div class="mt-6 flex justify-end">
            <div class="bg-white/60 rounded-full p-2 text-gray-400 hover:text-blue-500 transition-colors shadow-sm">
